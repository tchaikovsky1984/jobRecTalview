...
export type Query_Root = {
  ...
  /** execute function "search_jobs" which returns "job" */
  search_jobs: Array<Job>;
  /** execute function "search_jobs" and query aggregates on result of table type "job" */
  search_jobs_aggregate: Job_Aggregate;
...
export type Query_RootSearch_JobsArgs = {
...
export type Query_RootSearch_Jobs_AggregateArgs = {
  args: Search_Jobs_Args;
  distinct_on?: InputMaybe<Array<Job_Select_Column>>;
  limit?: InputMaybe<Scalars['Int']['input']>;
  offset?: InputMaybe<Scalars['Int']['input']>;
...
export type Search_Jobs_Args = {
  limit_count?: InputMaybe<Scalars['Int']['input']>;
  query_vector?: InputMaybe<Scalars['vector']['input']>;
};
...
export type Subscription_RootSearch_JobsArgs = {
  args: Search_Jobs_Args;
  distinct_on?: InputMaybe<Array<Job_Select_Column>>;
  limit?: InputMaybe<Scalars['Int']['input']>;
  offset?: InputMaybe<Scalars['Int']['input']>;
...
export type Subscription_RootSearch_Jobs_AggregateArgs = {
  args: Search_Jobs_Args;
  distinct_on?: InputMaybe<Array<Job_Select_Column>>;
  limit?: InputMaybe<Scalars['Int']['input']>;
  offset?: InputMaybe<Scalars['Int']['input']>;
...
export type UpsertPrepForRecMutationVariables = Exact<{
...
export type UpsertPrepForRecMutation = { __typename?: 'mutation_root', insert_interview_prep_one?: { __typename?: 'interview_prep', id: number } | null };

export type SelectJobByIdQueryVariables = Exact<{
  id: Scalars['Int']['input'];
}>;


export type SelectJobByIdQuery = { __typename?: 'query_root', job: Array<{ __typename?: 'job', title?: string | null, company?: string | null, description?: string | null, skills?: any | null, location?: string | null }> };

export type SelectRecommendationWithIdQueryVariables = Exact<{
  id: Scalars['Int']['input'];
}>;


export type SelectRecommendationWithIdQuery = { __typename?: 'query_root', recommendation: Array<{ __typename?: 'recommendation', id: number, res_id: number, job_id: number, score: any, reasoning?: string | null, skill_matches?: any | null, skill_misses?: any | null }> };

export type BulkInsertRecommendationMutationVariables = Exact<{
  objects: Array<Recommendation_Insert_Input> | Recommendation_Insert_Input;
}>;


export type BulkInsertRecommendationMutation = { __typename?: 'mutation_root', insert_recommendation?: { __typename?: 'recommendation_mutation_response', affected_rows: number, returning: Array<{ __typename?: 'recommendation', id: number }> } | null };

export type SelectResumeEmbSkillSumQueryVariables = Exact<{
  id: Scalars['Int']['input'];
  user_id: Scalars['Int']['input'];
}>;


export type SelectResumeEmbSkillSumQuery = { __typename?: 'query_root', resume: Array<{ __typename?: 'resume', embedding?: any | null, summary?: string | null, extracted_skills?: any | null }> };

export type SelectJobsWithSimilarityQueryVariables = Exact<{
  embedding: Scalars['vector']['input'];
  limit: Scalars['Int']['input'];
}>;


export type SelectJobsWithSimilarityQuery = { __typename?: 'query_root', search_jobs: Array<{ __typename?: 'job', id: number, title?: string | null, company?: string | null, description?: string | null, skills?: any | null, location?: string | null, embedding?: any | null, url?: string | null, search_title?: string | null, search_pref_country?: string | null, search_pref_area?: string | null }> };

export type SelectResumeSkillSumQueryVariables = Exact<{
  id: Scalars['Int']['input'];
}>;


export type SelectResumeSkillSumQuery = { __typename?: 'query_root', resume: Array<{ __typename?: 'resume', summary?: string | null, extracted_skills?: any | null }> };


export const UpsertPrepForRecDocument = gql`
    mutation UpsertPrepForRec($rec_id: Int!, $questions: jsonb, $tips: _text, $topics: _text) {
  insert_interview_prep_one(
    object: {recommendation_id: $rec_id, questions: $questions, tips: $tips, topics: $topics}
    on_conflict: {constraint: interview_prep_recommendation_id_key, update_columns: [questions, tips, topics]}
  ) {
    id
  }
}
    `;
export const SelectJobByIdDocument = gql`
    query SelectJobById($id: Int!) {
  job(where: {id: {_eq: $id}}) {
    title
    company
    description
    ...
    `;
export const SelectRecommendationWithIdDocument = gql`
  ...
  recommendation(where: {id: {_eq: $id}}) {
    ...
    `;
export const BulkInsertRecommendationDocument = gql`
    mutation BulkInsertRecommendation($objects: [recommendation_insert_input!]!) {
  insert_recommendation(
    objects: $objects
    on_conflict: {constraint: recommendation_res_id_job_id_key, update_columns: [score, reasoning, skill_matches, skill_misses]}
  ) {
    affected_rows
    returning {
      id
    ...
    `;
export const SelectResumeEmbSkillSumDocument = gql`
  ...
  resume(where: {_and: [{id: {_eq: $id}}, {user_id: {_eq: $user_id}}]}) {
    ...
    `;
export const SelectJobsWithSimilarityDocument = gql`
  ...
  search_jobs(args: {query_vector: $embedding, limit_count: $limit}) {
    ...
    `;
export const SelectResumeSkillSumDocument = gql`
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    UpsertPrepForRec(variables: UpsertPrepForRecMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<UpsertPrepForRecMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<UpsertPrepForRecMutation>({ document: UpsertPrepForRecDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'UpsertPrepForRec', 'mutation', variables);
    },
    SelectJobById(variables: SelectJobByIdQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<SelectJobByIdQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<SelectJobByIdQuery>({ document: SelectJobByIdDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'SelectJobById', 'query', variables);
    },
    SelectRecommendationWithId(variables: SelectRecommendationWithIdQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<SelectRecommendationWithIdQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<SelectRecommendationWithIdQuery>({ document: SelectRecommendationWithIdDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'SelectRecommendationWithId', 'query', variables);
    },
    BulkInsertRecommendation(variables: BulkInsertRecommendationMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<BulkInsertRecommendationMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<BulkInsertRecommendationMutation>({ document: BulkInsertRecommendationDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'BulkInsertRecommendation', 'mutation', variables);
    },
    SelectResumeEmbSkillSum(variables: SelectResumeEmbSkillSumQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<SelectResumeEmbSkillSumQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<SelectResumeEmbSkillSumQuery>({ document: SelectResumeEmbSkillSumDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'SelectResumeEmbSkillSum', 'query', variables);
    },
    SelectJobsWithSimilarity(variables: SelectJobsWithSimilarityQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<SelectJobsWithSimilarityQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<SelectJobsWithSimilarityQuery>({ document: SelectJobsWithSimilarityDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'SelectJobsWithSimilarity', 'query', variables);
    },
    SelectResumeSkillSum(variables: SelectResumeSkillSumQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<SelectResumeSkillSumQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<SelectResumeSkillSumQuery>({ document: SelectResumeSkillSumDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'SelectResumeSkillSum', 'query', variables);
    }
  };
}
